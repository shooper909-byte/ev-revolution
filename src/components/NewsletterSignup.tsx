    ...
    <div className={compact ? "" : "max-w-md"}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row">
        ...
        <input
          ...
          className="hairline min-w-0 flex-1 border-b bg-transparent px-1 py-3 text-sm text-ivory placeholder:text-taupe-700 focus:border-champagne focus:outline-none"
        />
        <button
          type="submit"
